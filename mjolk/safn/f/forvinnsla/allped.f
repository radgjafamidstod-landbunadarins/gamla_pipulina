...
!     parameter(norec =184499) ! Wxx0 mai2017
!     parameter(norec =186515) ! Wxx0 okt2017
!     parameter(norec =191158) ! Wxx0 mai2018
!     parameter(norec =195658) ! Wxx0 jan2019
!     parameter(norec =199480) ! Wxx0 okt2019 endurgert
!     parameter(norec =202056) ! Wxx0 jan2020
!     parameter(norec =204319) ! Wxx0 jun2020
      parameter(norec =207518) ! Wxx0 jan2021
...
!     parameter(noped =560488) ! pgrees.mj19
!     parameter(noped =560012) ! pgrees.j19 !endurgert
!     parameter(noped =576365) ! pgrees.o19 
!     parameter(noped =576353) ! pgreess.o19 endurgert 
!     parameter(noped =586578) ! pgrees.j20 
!     parameter(noped =596523) ! pgrees.jun20 
      parameter(noped =611149) ! pgrees.jan21 
!     parameter(noped =515917) ! pgrees.m17
      parameter(nony  =200000)
...
!     open(11,file=pth//'pgrees.o17')
!     open(11,file=pth//'pgrees.m18')
!     open(11,file=pth//'pgrees.mj19')
!     open(11,file=pth//'pgrees.j19') ! endurgert21/1
!     open(11,file=pth//'pgrees.o19') 
!     open(11,file=pth//'pgreess.o19') 
!     open(11,file=pth//'pgrees.j20') 
!     open(11,file=pth//'pgrees.jun20') 
      open(11,file=pth//'pgrees.jan21') 
!     open(11,file=pth//'pgreess.m17')
...
c         endif   
c        else
!           write(9,*)'Not found in pedigree file',aett(1,i)
            write(9,*)'Not found in pedigree file',aett(1,i), ind
