...
c-----------------------------------------------------------------------
     ...
     +         ix3(maxani),ka(maxft),kc(nofill),noficl(0:maxfix)
      integer*4 rix(0:norbl),iter,ixmod,ip
      integer*4 beq(maxfix,notrt,maxani),ix1(maxani)
      character dird*5
      character dagtim*25
      logical loadold,pr
...
c     call fdate(dagtim)
      write(66,*)'Output from program IMPL ',dagtim
      write(66,*)'..................................................'
...
c       print *,'Convergence level of fixed part:',convf3
c...................  XRX loop..........................................
      end do
c     goto 781
...
c     call cumtim(cumstr)
c     call wallcl(dumstr)
      write(66,*)' CPU time: ', cumstr
      write(66,*)' Total wall clock time: ', dumstr
      print *,' CPU time: ', cumstr
      print *,' Total wall clock time: ', dumstr
...
c---------------------- ...done ----------------------------------------
c     call fdate(dagtim)
      write(66,*)'...end of output from program IMPL ',dagtim
      write(66,*)'............................................'
      print *,'            ...done'
  999 stop
      end
...
!     include '/home/agust/agusts/assub/nolli3.f'
!     include '/home/agust/agusts/assub/nollm.f'
!     include '/home/agust/agusts/assub/nollmi.f'
...
!!    include '/home/LBHI/elsa/elsaagust/agusts/assub/nolli3.f'
...
!!    include '/home/LBHI/elsa/elsaagust/agusts/assub/nollr4.f'
      ...
      include '/home/elsa/elsaagust/agusts/assub/nolli3.f'
