...
c...missing value if t=miss
      miss=-9.0
      open( 9,file='data/var.txt',status='old')
      open(10,file='data/ped.txt',status='old')
      open(11,file='data/trait.txt',status='old')
      open(12,file='data/fixed.txt',status='old')
      open(13,file='keep/di.txt',status='old')
      open(14,file='data/model.txt',status='old')
      open(15,file='dump/Winfo.txt')
      open(17,file='dump/Wimpl17.bin',form='unformatted')
      ...
      open(66,file='keep/Rpreimpl.log')
c     call fdate(dagtim)
c     write(66,*)'Output from program PREIMPL ',dagtim
      write(66,*)'.....................................................'
      read(14,*)noani,nofix 
...
c-----------------------------------------------------------------------
      ...
      do i=1,noani
         ...
         read(11,'(2f5.0)')(t(j,i),j=1,notrt)
         read(12,'(2i2)')ifx1,ifx2
	 if(ifx1.eq.0.and.t(1,i).ne.-9.0)print *,'Ekki rett 1!!'
	 if(ifx1.ne.0.and.t(1,i).eq.-9.0)print *,'Ekki rett 1!!'
	 if(ifx2.eq.0.and.t(2,i).ne.-9.0)print *,'Ekki rett 2!!'
	 if(ifx2.ne.0.and.t(2,i).eq.-9.0)print *,'Ekki rett 2!!'
         fix(1,1,i)=ifx1
         fix(1,2,i)=ifx2
...
c...write the non-zero upper-diagonal XRX part to tmp file
      open(20,file='dump/xrx.tmp',form='unformatted')
      i99=0
      do i=1,nofill
