...
c... Traces pedigrees
      ...
      pth='/home/LBHI/agust/BASSI/mjaltir/'
      open(09,file=pth//'vinnsla/Rpedrekur.log')
c     open(10,file=pth//'vinnsla/mjalt.Wxx1')
      open(10,file=pth//'safn/mjal0409a')
      open(11,file=pth//'../mjolk/safn/pgree.a09')
      open(22,file=pth//'vinnsla/mjalt.prodped')
      do i=1,30
       null30(i)=0
      enddo
c 210 format(i4,i7,i4,i4,i7,i4,i4,i7,i4)
...
c...Skrifa ut kyr med gogn
     ...
     +  (idam(jm,i),jm=1,3),2,icbu(i),(rp(jn,i),jn=4,6)
      enddo
c...Skrifa ut aetternisgripi
      do i=1,iny
          write(22,230)(ny(jk,i),jk=1,9),ny(12,i),0,0,0,0
      enddo
      close(9)
      close(10)
      close(11)
...
c...Rada safnskra afurda og aetternisgripa
     ...
     + /home/LBHI/agust/BASSI/mjaltir/vinnsla/mjalt.prodped
     + -o/home/LBHI/agust/BASSI/mjaltir/vinnsla/mjalt.Wxx2')
      call exec('sync')
c... fin
      stop
      end
