...
c-----------------------------------------------------------------------
      parameter(    nt =        1)
      parameter( nofix =        3)
c     parameter(   nht =   460443)
c     parameter(    nf =     8308)
!     parameter(   nht =   473396)
!     parameter(    nf =     8645)
!!    parameter(   nht =   485745)
!!    parameter(    nf =     8849)
!     parameter(   nht =   498812)
!     parameter(    nf =     9052)
!     parameter(   nht =   508639)
!     parameter(    nf =     9321)
!     parameter(   nht =   528849)
!     parameter(    nf =     9711)
!     parameter(   nht =   539230) ! okt2017
!     parameter(   nht =   556303) ! mai2018
!     parameter(   nht =   573772) ! jan2019
!     parameter(   nht =   590776) ! okt2019
!     parameter(   nht =   601418) ! jan2020
!     parameter(   nht =   611767) ! jun2020
      parameter(   nht =   626832) ! jan2021
!     parameter(    nf =     9823) !okt2017
!     parameter(    nf =    10189) !mai2018
!     parameter(    nf =    10420) !jan2019
!     parameter(    nf =    10810) !okt2019
!     parameter(    nf =    10923) !jan2020
!     parameter(    nf =    11118) !jun2020
      parameter(    nf =    11276) !jan2021
      integer nfi(4),nh(nf,nofix),nrt(2,nht),ifix(nofix)
     + ,lfix(nofix)
...
!       write(*,103)ire,(ifix(j),j=1,nofix),ind,no1,no2,isire,idam,isex
        if(ire.gt.0)then
          nh(ifix(1),1)=nh(ifix(1),1)+1
          nh(ifix(2),2)=nh(ifix(2),2)+1
          nh(ifix(3),3)=nh(ifix(3),3)+1
c         nh(ifix(4),4)=nh(ifix(4),4)+1
        endif
  280 continue
! 103 format(i1,i4,i1,i2,i6,2i4,2i6,i1)
! nu er fixed yfir 10000 svo tad tarf ad vikka ut toluna
  103 format(i1,i5,i1,i2,i6,2i4,2i6,i1)
      rewind 13
      write(*,*)'                     ...done'
...
c      information about fixed classes
        ...
        if(ire.gt.0)then
          ...
          x2=nh(ifix(2),2)
          x3=nh(ifix(3),3)
          d1(ind)=d0(ind)-1.d0/x1-1.d0/x2-1.d0/x3
        else
          d1(ind)=d0(ind)
        endif
...
c ...............................................
              ...
              if(lre.gt.0)then
                ...
                x2=nh(lfix(2),2)
                x3=nh(lfix(3),3)
                d1s=d0s-1.d0/x1-1.d0/x2-1.d0/x3
              else
                d1s=d0s
              endif
              if(ldam.eq.0)then
...
c ...............................................
              ...
              if(lre.gt.0)then
                ...
                x2=nh(lfix(2),2)
                x3=nh(lfix(3),3)
                d1d=d0d-1.d0/x1-1.d0/x2-1.d0/x3
              else
                d1d=d0d
              endif
              if(lsire.eq.0)then
