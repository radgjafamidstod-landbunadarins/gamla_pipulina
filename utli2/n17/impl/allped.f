...
c... PEDREKUR.F
c... Traces pedigrees
c     parameter(norec =84418) !conf.Wxx1
c     parameter(noped =453604)
c     parameter(nony  =100000)
!     parameter(norec =88597)!n17/conf.Wxx1
!     parameter(norec =91166)!n17/conf.Wxx1
!     parameter(norec =93819)!n17/conf.Wxx1
!     parameter(norec =96944)!n17/conf.Wxx1
!     parameter(norec =101497)!n17/conf.Wxx1
!     parameter(norec =103020)!n17/conf.Wxx1
!     parameter(norec =111545)!n17/conf.Wxx1
!     parameter(norec =116476)!n17/conf.Wxx1
!     parameter(norec =118466)!n17/conf.Wxx1
!     parameter(norec =121168)!n17/conf.Wxx1
      parameter(norec =124064)!n17/conf.Wxx1
!     parameter(noped =466316)
!     parameter(noped =478548)
!     parameter(noped =491304)
!     parameter(noped =500881)
!     parameter(noped =515915)
!     parameter(noped =526154)
!     parameter(noped =542634)
!     parameter(noped =560012)
!     parameter(noped =576353)
!     parameter(noped =586577)
!     parameter(noped =596523)
      parameter(noped =611149)
!     parameter(nony  =100000)
      ...
      real*8  dam,sire,ind
      integer pl,null30(30),vixl(6),isire(3,norec),idam(3,norec)
      integer lasth,cherd,ih1,isex(norec)
c     character las*1,clas*1,pth*33
!!    character las*1,clas*1,pth*30
      character las*1,clas*1,pth*25
...
c...Skrifa ut kyr med gogn
     ...
     +  (idam(jm,i),jm=1,3),isex(i),(rp(jn,i),jn=4,24)
      enddo
      close(9)
      close(10)
      close(11)
...
c    + /home/agust/skuggi_kyr/utli2/n17/conf.prodped
c    + -o/home/agust/skuggi_kyr/utli2/n17/conf.Wxx2')
!!   + /home/LBHI/elsa/Kyr/utli2/n17/conf.prodped
!!   + -o/home/LBHI/elsa/Kyr/utli2/n17/conf.Wxx2')
     + /home/elsa/Kyr/utli2/n17/conf.prodped
     + -o/home/elsa/Kyr/utli2/n17/conf.Wxx2')
      call exec('sync')
c... fin
      stop
      end
