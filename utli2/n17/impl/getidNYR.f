...
c     parameter(noani = 460443)!conf.Rmail
!     parameter(noani = 473396)
!!    parameter(noani = 485745)
!     parameter(noani = 498812)
!     parameter(noani = 508639)
!     parameter(noani = 528849)
!     parameter(noani = 539230) ! config.Rmain okt2017
!     parameter(noani = 556303) ! config.Rmain mai2018
!     parameter(noani = 573772) ! config.Rmain jan2019
!     parameter(noani = 590776) ! config.Rmain okt2019
!     parameter(noani = 601418) ! config.Rmain jan2020
!     parameter(noani = 611767) ! config.Rmain jun2020
      parameter(noani = 626832) ! config.Rmain jan2021
...
c.....Read files..........................
  ...
  199 continue
  210 format(i6,3(i4,i7,i4),i4,i2,i3,i1,i2,17i2)
  220 format(3i7)
